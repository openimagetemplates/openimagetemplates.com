...
const blogTemplateHints: Record<string, string[]> = {
  "ai-image-prompt-templates-faster-creative-work": ["tattoo-flash-sheet", "coffee-shop-lifestyle", "real-estate-exterior-dusk", "pixel-art-game-scene"],
  "write-reusable-ai-image-prompts-with-variables": ["streetwear-lookbook-grid", "ceramic-brand-still-life", "weather-satellite-map", "tarot-card-archetype"],
  "fixed-prompts-vs-template-prompts": ["surreal-double-exposure", "corporate-headshot-studio", "architectural-section-cutaway", "sports-action-freeze"],
  "build-prompt-template-product-photography": ["luxury-watch-wristshot", "food-magazine-flat-lay", "macro-jewelry-sparkle", "eco-packaging-mockup"],
  "consistent-portrait-generation-prompt-templates": ["chiaroscuro-studio-portrait", "underwater-fashion-dream", "neon-nightlife-portrait", "gilded-fantasy-painterly-portrait"],
  "ai-image-prompts-checklist-before-you-generate": ["science-museum-display", "botanical-science-plate", "drone-top-down-landscape", "exploded-tech-diagram"],
  "inconsistent-ai-images-structured-templates": ["minimal-line-coloring-page", "claymation-character-still", "board-game-box-art", "embroidered-patch-design"],
  "cinematic-scene-prompt-templates-ai-art": ["noir-detective-scene", "haunted-library-interior", "abandoned-mech-cockpit", "blacklight-concert-stage"],
  "reuse-ai-prompts-across-different-image-tools": ["low-poly-icon-set", "isometric-app-dashboard", "minimal-saas-dashboard-hero", "museum-artifact-photogrammetry"],
  "complete-guide-ai-image-prompt-structures": ["fantasy-map-parchment", "storybook-watercolor-scene", "architectural-concept-model", "floating-island-fantasy"],
  ...
  "prompt-galleries-vs-prompt-template-standards": ["movie-poster-remix", "bright-bedroom-mirror-selfie", "solarpunk-rooftop-garden"],
  "open-image-templates-vs-prompt-marketplaces": ["album-cover-concept", "botanical-perfume-ad", "vinyl-toy-mascot"],
  ...
  "open-image-templates-vs-lexica-prompt-search": ["dreamy-forest-light", "neon-arcade-cabinet", "abstract-glassmorphism-wallpaper"],
  "midjourney-prompt-galleries-vs-open-image-templates": ["fantasy-warrior-key-art", "step-out-of-manga-book", "anime-hero-poster"],
  "best-prompt-template-sites-for-ai-image-generation": ["sunny-beach-product-shot", "travel-postcard-landmark", "recipe-card-flat-lay", "music-festival-poster-scene"],
  "hidden-prompts-vs-visible-prompts-ai-image-generation": ["glowing-word-forest-installation", "handmade-jewelry-bench", "scientific-cutaway-fruit"],
};
